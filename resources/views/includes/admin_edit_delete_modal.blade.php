        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/admins/update/{{ $admin->id }}"
                    ...
                    <div class="form-group col-md-6">
                        <label for="old_password{{ $admin->id }}" class="label label-default">Ancien mot de passe</label>
                        <input type="password" name="old_password"  identifiant={{ $admin->password ?? '' }} id="old_password{{ $admin->id }}" data-id="{{ $admin->id ?? '' }}" class="form-control" onblur="verifier_password(this)" >
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6" id="new_password_group{{$admin->id}}" style="display: none;">
                            <label for="new_password{{$admin->id}}" class="label label-default">Nouveau mot de passe</label>
                            <input type="password" name="password" class="form-control" id="new_password{{$admin->id}}">
                        </div>

                        <!-- Champ pour la confirmation du nouveau mot de passe -->
                        <div class="form-group col-md-6" id="edit_password_confirmation_group{{$admin->id}}" style="display: none;">
                            <label for="edit_password_confirmation{{$admin->id}}" class="label label-default">Confirmer le nouveau mot de passe</label>
                            <input type="password" name="password_confirmation" class="form-control" id="edit_password_confirmation{{$admin->id}}" onblur="validatePassword_edit(this)" identifiant="{{$admin->id}}">
                    ...
                    <div class="btn-group col-md-6" role="group">
                        <button type="submit" id= "edit_enregistrer{{$admin->id}}" class="btn btn-primary col-md-12" validate_valeur="true" verifier_valeur="true">Enregistrer </button>
                    </div>
